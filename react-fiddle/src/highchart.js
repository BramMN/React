    ...
    render() {
        ...
        config = {
            ...
            series: [{
                type: 'area',
                name: 'USD to EUR',
                /* This data from  page http://jsfiddle.net/highcharts/6etwu5b4/
                from link $.getJSON('https://www.highcharts.com/samples/data/jsonp.php?filename=usdeur.json&callback=?' /*
                 */
